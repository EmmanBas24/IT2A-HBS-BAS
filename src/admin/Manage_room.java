...
public class Manage_room extends javax.swing.JFrame {
         ...
         searchpanel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!username.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(Manage_room.this, "Please enter a username.");
                }
            }
        });
    }
    ...
    public void displayData(){
        try{
            dbConnector dbc = new dbConnector();
            ResultSet rs = dbc.getData("SELECT room_id AS 'ID', room_number AS 'Room Number', room_pricePerNight AS 'Price per Night', room_capacity AS 'Room Capacity', room_status AS 'Status' FROM tbl_room");
            rooms_table.setModel(DbUtils.resultSetToTableModel(rs));
             rs.close();
        }catch(SQLException ex){
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(searchpanel, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 20, 100, 40));
